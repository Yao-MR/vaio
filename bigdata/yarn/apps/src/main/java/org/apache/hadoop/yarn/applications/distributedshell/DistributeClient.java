...
public class DistributeClient {
    ...
    private static final Log LOG = LogFactory.getLog(DistributeClient.class);
     ...
     *
     */
    public DistributeClient(Configuration conf) throws Exception {
    ...
    DistributeClient(String appMasterMainClass, Configuration conf) {
        this.conf = conf;
    ...
    public boolean init(String[] args) throws ParseException {
        ...
        if (cliParser.hasOption("log_properties")) {
            ...
            try {
                Log4jPropertyHelper.updateLog4jConfiguration(DistributeClient.class, log4jPath);
            } catch (Exception e) {
        ...
        appName = cliParser.getOptionValue("appname", "应用名称");
