...
public class DshellApplicationMaster {
    ...
    private static final String ExecShellStringPath = DistributeClient.SCRIPT_PATH + ".sh";
    private static final String ExecBatScripStringtPath = DistributeClient.SCRIPT_PATH
            + ".bat";
